...
class SourceClass {
    ...
    final private static String PACKAGE_NAME = SourceClass.class.getPackage().getName();
    ...
    private void addClassDeclaration(String body) {
        content.append("public final class ").
                append(className).
                append(" implements ").
                append(Mapper.class.getPackage().getName()).
                append(".").
                append(Mapper.class.getSimpleName()).
                append("<").
                append(source.getCanonicalName()).
                append(",").
